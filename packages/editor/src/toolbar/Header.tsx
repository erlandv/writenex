...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
} from "@writenex/ui" // dropdown-menu";
import { SimpleTooltip } from "@writenex/ui" // simple-tooltip";
import { IconButton } from "@writenex/ui" // icon-button";
import { useEditorStore, getActiveDocument } from "@writenex/store";
import { cn } from "@writenex/utils";
import { getImage, saveSetting } from "@writenex/db";
import {
