...
import { Header } from "@/components/editor/toolbar";
import { FocusModeOverlay, UpdatePrompt } from "@/components/editor/indicators";
...
const MarkdownEditor = dynamic(
  () =>
    import("@/components/editor/MarkdownEditor").then(
